...
| ST-03 | Mint OpenPI Service Plane | in_progress | `src/mint` | 在 Mint 内建立隔离的 OpenPI 服务平面与生命周期管理 | [subtarget-03-mint-openpi-service-plane.md](./subtarget-03-mint-openpi-service-plane.md) |
